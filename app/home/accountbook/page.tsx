...
const page = () => {
  ...
  return (
    ...
    <Backdrop isOpen={isCashPaymentOpen || isCashReceivedOpen} onClose={onCloseCashPayment || onCloseCashReceived}>
        <Card>
          <div className="flex flex-col gap-3 p-5 w-[30rem]">
            ...
            <div className="flex justify-between mt-5">
              <button
                className="bg-blue-500 px-3 py-2 rounded "
                onClick={() =>{ setIsCashPaymentOpen(false)
                 setIsCashReceivedOpen(false) }}
              >
                Save
              </button>
    ...
    <div className='flex justify-end gap-2'>
      <button onClick={openNewLedger} className="flex items-center bg-blue-500 hover:opacity-90 text-white py-2 px-4 rounded">
        <FaPlus className="mr-2" />
        New Ledger
      </button>
      <button onClick={openCashPayment} className="flex items-center bg-red-500 hover:opacity-90 text-white py-2 px-4 rounded">
        Cash Payment
      </button>
      <button onClick={openCashReceived} className="flex items-center bg-green-500 hover:opacity-90 text-white py-2 px-4 rounded">
        Cash Received
      </button>
